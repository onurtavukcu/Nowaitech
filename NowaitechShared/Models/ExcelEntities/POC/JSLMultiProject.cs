...
{
    public class JSLMultiProject : EntityBase
    {
        ...
        public int? Objekt_ID { get; set; } //object
        public string? Alt { get; set; }
        [ColumnName("NE-Typ")]
        public string? NE_Typ { get; set; }
        public string? POC_Projekt { get; set; }
        public string? POC_Kategorie { get; set; }
        public string? NE_Nr_EPlus { get; set; }
        public string? POC_Sourcing { get; set; }
        ...
        [ColumnName("JSL-Rolloutjahr")]
        public string? JSL_Rolloutjahr { get; set; }
        ...
        public string? MP_Plan_St82 { get; set; }
        public string? MP_Ist_St82 { get; set; }
        public string? MP_Plan_St82w { get; set; }
        public string? MP_Ist_St82w { get; set; }
        public string? MP_Plan_St90 { get; set; }
        public string? MP_Ist_St90 { get; set; }
        public string? MP_Ist_St91 { get; set; }
        [ColumnName("St82Plan-21AT")]
        public string? St82Plan_21AT { get; set; }
        ...
        [ColumnName("Objekt-Position")]
        public string? Objekt_Position { get; set; }
        ...
        [ColumnName("SO-A APT_33b_Ist")]
        public string? SO_A_APT_33b_Ist { get; set; }
        [ColumnName("SO-A APT_33b_Bem.")]
        public string? SO_A_APT_33b_Bem { get; set; }
        ...
        [ColumnName("SO-B APT_33b_Ist")]
        public string? SO_B_APT_33b_Ist { get; set; }
        [ColumnName("SO-B APT_33b_Bem.")]
        public string? SO_B_APT_33b_Bem { get; set; }
        ...
        [ColumnName("Link APT_10_Bem.")]
        public string? Link_APT_10_Bem { get; set; }
        ...
        [ColumnName("Link APT_45_Plan")]
        public string? Link_APT_45_Plan { get; set; }
        [ColumnName("Link APT_45_Ist")]
        public string? Link_APT_45_Ist { get; set; }
        [ColumnName("Link APT_45_Bem.")]
        public string? Link_APT_45_Bem { get; set; }
        [ColumnName("Link APT_48_Plan")]
        public string? Link_APT_48_Plan { get; set; }
        [ColumnName("Link APT_48_Ist")]
        public string? Link_APT_48_Ist { get; set; }
        [ColumnName("Link APT_48_Bem.")]
        public string? Link_APT_48_Bem { get; set; }
        ...
        [ColumnName("Linda_340 - prov_Bereitst_angezeigt")]
        public string? Linda_340___prov_Bereitst_angezeigt { get; set; }
        [ColumnName("Linda 340 - Plan Mitwirkungspflicht erfüllt")]
        public string? Linda_340___Plan_Mitwirkungspflicht_erfüllt { get; set; }
        [ColumnName("Linda 345 - Mitwirkungspflicht erfüllt")]
        public string? Linda_345___Mitwirkungspflicht_erfüllt { get; set; }
        [ColumnName("Linda 345 - unverb Liefertermin")]
        public string? Linda_345___unverb_Liefertermin { get; set; }
        [ColumnName("Linda Massenswap Datum")]
        public string? Linda_Massenswap_Datum { get; set; }
        [ColumnName("Linda Massenswap Status Datum")]
        public string? Linda_Massenswap_Status_Datum { get; set; }
        [ColumnName("Linda Auftragsnummer (DTAG)")]
        public string? Linda_Auftragsnummer_DTAG { get; set; }
        ...
        public string? Ist_Stx44a { get; set; }
        ...
        public string? Ist_Stx92 { get; set; }
        ...
        public string? Equipment_Bestand { get; set; }
        public string? Equipment_Projekt { get; set; }
        ...
        public string? Ist_Stx33b { get; set; }
        public string? Ist_Stx29b { get; set; }
        [ColumnName("Stx29b_Bem.")]
        public string? Stx29b_Bem_ { get; set; }
        public string? Ist_Stx49l { get; set; }
        [ColumnName("Stx49l_Bem.")]
        public string? Stx49l_Bem_ { get; set; }
        public string? Ist_Stx56l { get; set; }
        [ColumnName("Stx56l_Bem.")]
        public string? Stx56l_Bem_ { get; set; }
        public string? Ist_Stx60l { get; set; }
        [ColumnName("Stx60l_Bem.")]
        public string? Stx60l_Bem_ { get; set; }
        public string? Ist_Stx42l { get; set; }
        [ColumnName("Stx42l_Bem.")]
        public string? Stx42l_Bem_ { get; set; }
        public string? Ist_Stx57 { get; set; }
        [ColumnName("Stx57_Bem.")]
        public string? Stx57_Bem_ { get; set; }
        public string? Ist_Stx58 { get; set; }
        [ColumnName("Stx58_Bem.")]
        public string? Stx58_Bem_ { get; set; }
        ...
        [ColumnName("Stx73a_Bem.")]
        public string? Stx73a_Bem_ { get; set; }
        public string? Plan_Stx74 { get; set; }
        public string? Ist_Stx74 { get; set; }
        [ColumnName("Stx74_Bem.")]
        public string? Stx74_Bem_ { get; set; }
